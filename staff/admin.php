...
<body>
    <div class="container">
        <div class="nav">
            <p>CMS</p>
            <p1>All Complaints:<?php echo $num; ?></p1>
            <p1>Resolved Complaints:<?php echo $num1 ; ?></p1>
            <p1>Pending Complaints:<?php echo $num2; ?></p1>
            <p1>High Priority Complaints:<?php echo $num3; ?></p1>
            <p1>Unassigned Complaints:<?php echo $num4; ?></p1>
            <a href="../destroy.php" >
                <button class="logb" >
                    Logout
                </button>
